...
const About: React.FC = () => {
  return (
    <section className="my-24 px-4 max-w-4xl mx-auto text-center">
      <h2 className="text-3xl font-bold mb-4">What is Cadence Club?</h2>
      <p className="text-gray-700 text-lg mb-8">
        Cadence Club is a series of members-only golf events that lets you play
        public courses without the 5-hour rounds. Cadence Club blocks off
